...
## Step3: BRS checking
```{r, warning=FALSE, message=FALSE}
metaphlan2_ps_species_LOD <- readRDS("DataSet/Step2/Donor_MGS_phyloseq_species_LOD.RDS")
tail(metaphlan2_ps_species_LOD@sam_data %>% data.frame())
...
# alpha
metaphlan2_ps_remove_BRS_LOD_species_alpha <- run_alpha_diversity(ps=metaphlan2_ps_remove_BRS_LOD_species, 
                                                measures = c("Shannon", "Simpson", "InvSimpson"))
plot_boxplot(data=metaphlan2_ps_remove_BRS_LOD_species_alpha,
...
# beta
metaphlan2_ps_remove_BRS_LOD_species_beta <- run_beta_diversity(ps=metaphlan2_ps_remove_BRS_LOD_species, method = "bray")
plot_distance_corrplot(metaphlan2_ps_remove_BRS_LOD_species_beta$BetaDistance)

# permanova
run_permanova(ps=metaphlan2_ps_remove_BRS_LOD_species, method = "bray", columns = "Group")
...
# filter & trim
metaphlan2_ps_remove_BRS_LOD_species_filter <- run_filter(metaphlan2_ps_remove_BRS_LOD_species, cutoff = 1e-4, unclass = TRUE)
metaphlan2_ps_remove_BRS_LOD_species_filter_trim <- run_trim(metaphlan2_ps_remove_BRS_LOD_species_filter, cutoff = 0.2, trim = "feature")
metaphlan2_ps_remove_BRS_LOD_species_filter_trim
...
saveRDS(metaphlan2_ps_remove_BRS_LOD_species_filter_trim, "DataSet/Step6/Donor_MGS_phyloseq_remove_BRS_LOD_species_filter_trim.RDS", compress = TRUE)
```
