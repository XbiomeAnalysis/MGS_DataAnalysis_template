...
metaphlan2_ps_LOD_species_per <- run_permanova(ps=metaphlan2_ps_LOD_species, method = "bray", columns = "Group")
...
## beta dispersion 
```{r}
beta_df <- run_beta_diversity(ps=metaphlan2_ps_LOD_species, method = "bray", group = "Group")
```
