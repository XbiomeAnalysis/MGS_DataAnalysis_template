...
metaphlan2_ps_species_per <- run_permanova(ps=metaphlan2_ps_species, method = "bray", columns = "Group")
print(metaphlan2_ps_species_per)
```
...
## beta dispersion 
```{r}
beta_df <- run_beta_diversity(ps=metaphlan2_ps_species, method = "bray", group = "Group")
```
