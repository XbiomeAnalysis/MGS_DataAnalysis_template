...
metaphlan2_ps_LOD_species_alpha <- run_alpha_diversity(ps=metaphlan2_ps_LOD_species, measures = c("Shannon", "Simpson", "InvSimpson"))
...
metaphlan2_ps_LOD_beta <- run_beta_diversity(ps=metaphlan2_ps_LOD_species, method = "bray", group = "Group")
