...
i = 1
s = paste0('title: "MGS microbiota data analysis based on XMAS package (', c('Bootstrap', 'Tufte'), ' Style)"')
for (fmt in c('html_book', 'tufte_html_book')) {
  ...
  i = i + 1
  bookdown::publish_book(paste0('MGS_tutorial', i))
}
unlink('_book', recursive = TRUE)
...
bookdown::publish_book('MGS_tutorial')
