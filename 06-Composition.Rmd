...
plot_stacked_bar_XIVZ(
        phyloseq = metaphlan2_ps_remove_BRS,
        level = "Phylum",
        feature = "Group")
```
...
pl_core <- plot_core_taxa(metaphlan2_ps_species_filter_trim, 
                    plot.type = "heatmap", 
...
core_taxa_name <- core_members(metaphlan2_ps_species_filter_trim, detection = 0.01, prevalence = 0.5)
